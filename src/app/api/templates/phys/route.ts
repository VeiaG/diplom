...
import { PHYS_FILE_NAME } from "@/globals";
...
export const GET = auth( async (req) => {
    try{
        ...
        const buffer = await getOriginalFile(PHYS_FILE_NAME);
        ...
        return new NextResponse(new ReadableStream({
            ...
            headers: {
                ...
                'Content-Disposition': `attachment; filename="${PHYS_FILE_NAME}"`,
            },
        });
    } catch (err) {
